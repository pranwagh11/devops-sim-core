...
function AppShell() {
  ...
  const handleResetLocalData = () => {
    if (!confirm(
      "This deletes every Module, Lesson, Challenge, and Project stored in this browser and " +
      "reloads with the bundled seed data. This cannot be undone — export a backup first if you " +
      "want to keep anything. Continue?"
    )) return;
      ...
      <nav className="nav-bar">
        ...
        {role === "admin" && (
          <>
            ...
            <button className="nav-action nav-action-danger" onClick={handleResetLocalData}>Reset Local Data</button>
